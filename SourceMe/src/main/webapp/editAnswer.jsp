	...
	<body>
		...
		<div class="create-body">
			<div class="container">
		        ...
		        <c:if test="${answer != null}">
							<input type="hidden" name="ansId" value="<c:out value='${answer.id}' />" />
						</c:if>
		        <!-- Question Id -->
		        <c:if test="${answer != null}">
							<input type="hidden" name="qnsId" value="<c:out value='${answer.qnsId}' />" />
						</c:if>
						<!-- Post By -->
						<c:if test="${answer != null}">
							<input type="hidden" name="postBy" value="<c:out value='${answer.postBy}' />" />
						</c:if>
		        <!--My Answer-->
